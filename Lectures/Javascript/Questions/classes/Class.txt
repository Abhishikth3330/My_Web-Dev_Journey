...
//     constructor(name, maxDevices, support, storageLimit) {
//         if (new.target == SubscriptionPlan) {
//             throw new Error("Cannot instantiate abstract class SubscriptionPlan directly")
//         }
//         this.name = name;
...
//     getDetails() {
//         return `${this.getBasicInfo()}, Grade: ${this.grade}`;
//     }
// }
...
//     getDetails() {
//         return `${this.getBasicInfo()}, Subjects: ${this.subject}`;
//     }
// }
...
//     getDetails() {
//         return `${this.getBasicInfo()}, Position: ${this.position}`;
//     }
// }

// const student = new Student("Alice", 16, "10th Grade");
// const teacher = new Teacher("Mr. Smith", 40, "Maths");
// const staff = new Staff("Mrs. Johnson", 50, "Librarian");
...
//         console.log(`Task: ${this.name} rescheduled to ${this.deadline}`);
//     }

//     getDetails() {
//         return `Task ${this.name}, Deadline: ${this.deadline}, Priority: ${this.priority}, Completed: ${this.completed}.`
//     }
// }

// const task1 = new Task("Submit Assignment", "2025-05-10", "High");
// const task2 = new Task("Team Meeting", "2025-05-08", "Medium");
